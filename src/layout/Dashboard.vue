    ...
    <main>
                            ...
                            <div class="flex items-center px-2 lg:px-0">
                                ...
                                <div class="hidden lg:ml-10 lg:block">
                                    <div class="flex space-x-4">
                                        ...
                                        <a href="#"
                                            class="text-white hover:bg-indigo-500 hover:bg-opacity-75 rounded-md py-2 px-3 text-sm font-medium transform transition hover:scale-125 duration-600 ease-in-out">Loan Repayment</a>
                                        <a href="#"
                                            class="text-white hover:bg-indigo-500 hover:bg-opacity-75 rounded-md py-2 px-3 text-sm font-medium transform transition hover:scale-125 duration-600 ease-in-out">Loan History</a>
                                        <a href="#"
                                            class="text-white hover:bg-indigo-500 hover:bg-opacity-75 rounded-md py-2 px-3 text-sm font-medium transform transition hover:scale-125 duration-600 ease-in-out">User Details</a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="hidden lg:ml-4 lg:block">
                                <div class="flex items-center">
                                    ...
                                    <div class="relative ml-3 flex-shrink-0">
                                        <div>
                                            <button @click="userSettings=!userSettings" type="button"
                                                class="relative flex=!userSettings rounded-full bg-indigo-600 text-sm text-white"
                                                id="user-menu-button" aria-expanded="false" aria-haspopup="true">
                                                <span class="absolute -inset-1.5"></span>
                                                <span class="sr-only">Open user menu</span>

                                                <i class="transform transition hover:scale-90 duration-600 ease-in-out fas fa-user-gear fa-2x"></i>
                                            </button>
                                        </div>

                                  
                                        <div v-if="userSettings" class="absolute right-0 z-10 mt-2 w-48 origin-top-right rounded-md bg-white py-1 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none"
        ...
        <main class="-mt-32 ">
            <div class="mx-auto max-w-7xl px-4 pb-12 sm:px-6 lg:px-8">
                <div class="h-screen rounded-lg bg-white px-5 py-6 shadow-2xl sm:px-6">
                    <slot />
                </div>
            </div>
        </main>
